...
export default function HealthAnalysisPage() {
  ...
  return (
    <div className="flex-grow w-full px-2 md:px-10 lg:px-16 py-2 md:py-10 grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-6 relative">
      {/* Toast notification */}
      {toast && (
      ...
      {/* Main Analysis Panel */}
      <section className="lg:col-span-8 flex flex-col h-[calc(100vh-140px)] sm:h-[calc(100vh-150px)] md:h-[calc(100vh-140px)] min-h-[480px] glass-panel rounded-2xl md:rounded-[2rem] p-3 md:p-8 shadow-xs relative overflow-hidden">
        ...
        {/* Header */}
        <div className="mb-2 md:mb-4 pb-2 md:pb-4 border-b border-slate-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 md:gap-4 shrink-0 relative z-10">
          <div>
            <h1 className="text-[20px] md:text-[28px] leading-tight font-black text-slate-900 tracking-tight flex items-center gap-2">
              <span className="text-gradient-animated">Symptom Assessment</span>
            </h1>
            <p className="text-[12px] md:text-[14px] text-slate-500 mt-0.5 font-medium">Describe your concern or complete the interactive triage form.</p>
          </div>
          
          <div className="flex items-center gap-2 bg-teal-50 px-3 py-1 rounded-full border border-teal-200 shrink-0 badge-glow-teal animate-pulse-soft">
            ...
            <span className="text-[11px] font-bold text-teal-800 uppercase tracking-wider flex items-center gap-1">
              <span className="material-symbols-outlined text-[13px] text-teal-700">robot_2</span>
              AI Active
            </span>
          </div>
        </div>
        ...
        <div className="mb-2 flex flex-row gap-2 shrink-0 items-center overflow-x-auto scrollbar-none py-1 relative z-10 w-full">
